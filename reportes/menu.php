...
*/
		...
		//----------------		Usuario nivel 5 Validacion de Ingresos 		-----------------
										...
										<li><a href="#">Gasto en Proyectos</a>
											<ul>
												...
												<li><a href="#">Ingresos</font></a>
													<ul>
														<li><a href="listaIngresos.php">Ingresos Desglozados</a></li>
														<li><a href="listaReintegros.php">Reintegros Desglozados</a></li>
														<li><a href="listaIngresosXProyecto.php">Ingresos Por Proyecto</a></li>
														<li><a href="comppart.php">Comparativo de Partidas</a></li>
													</ul>
												</li>
												<li><a href="#">Egresos</a>
													<ul>
														<li><a href="listaEgresos.php">Egresos Desglozados</a></li>
														<li><a href="listaEgresosXProyecto.php">Egresos Por Proyecto</a></li>
													</ul>
												<li><a href="reportescapitulos.php">Reportes por Cap&iacute;tulos</a></li>
											</ul>
										</li>
									</ul>
								</li>
								...
								<li class="active"><a href="#">Reportes</a>
									<ul>
										...
										<li><a href="#">Gasto B&aacute;sico</a>
											<ul>
												<li><a href="gblistaIngresos.php">GB Ingresos Desglozados</a></li>
												<li><a href="gblistaEgresos.php">GB Egresos Desglozados</a></li>
												<li><a href="gbcompleto.php">GB Disponible</a></li>
											</ul>
										</li>
										<li><a href="#">Gasto N&oacute;mina</a>
											<ul>
												<li><a href="nmlistaIngresos.php">NM Ingresos Desglozados</a></li>
												<li><a href="nmlistaEgresos.php">NM Egresos Desglozados</a></li>
												<li><a href="nmcompleto.php">NM Disponible</a></li>
											</ul>
										</li>
									</ul>
								</li>
											...
											<ul>
												...
												<li><a href="#">Ingresos</font></a>
													<ul>
														...
														<li><a href="listaReintegros.php">Reintegros Desglozados</a></li>
														<li><a href="listaIngresosXProyecto.php">Ingresos Por Proyecto</a></li>
														<li><a href="sf.php">Solicitudes de Fondos</a></li>
														<li><a href="comppart.php">Comparativo de Partidas</a></li>
													</ul>
												</li>
												<li><a href="#">Egresos</a>
