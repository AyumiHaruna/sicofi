...
#------------------------------Egresos------------------------------------------
			...
			while($reg = mysqli_fetch_array($egresos))
			{
				if($egrNumProy == $reg['numeroProyecto'])
				{
					...
					$egrSumaImporteTotal = $reg['importeTotal'] + $egrSumaImporteTotal;
				}
				else
				{
					...
					$tablaArreglo[$y][4] = $egrSumaImporteTotal;
...
#-------------------------------------------------------------------------------
		...
		echo '<fieldset id="base">
				<fieldset id="formulario">
					<legend>Reporte de Cap&iacute;tulo 1000, 2000 y 3000</legend>';
