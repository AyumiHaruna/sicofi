...
<!--  /////////////////////////// DATOS DEL PROYECTO ////////////////////////////////// -->
  ...
  <script type="text/javascript">
    $( document ).ready(function() {
      ...
      //------------------------------------------------------------
			var numeroProyecto = <?php echo $_GET['codigo'] ?>;
			$(".panDatNumProy").val(numeroProyecto);
			getDatosProyecto(numeroProyecto);
    ...
    function justNumbers(e)
    {
      ...
      return /\d/.test(String.fromCharCode(keynum));
		...
		//------------------------------------------------------------
		//								Obteiene datos generales del proyecto
		//------------------------------------------------------------
		function getDatosProyecto(numProy)
		{
			$.ajax({
					data: { tipo:'getGenProyecto', numeroProyecto : numProy },
					type: "POST",
					url: "editaProyectosSube.php",
			})
				.done(function(msg){
					msg = $.parseJSON(msg);
					console.log(msg);
					$(".panDatCuen").val(msg['cuenta']);		$(".panDatNomProy").val(msg['nombreProyecto']);
					$(".panDatNomResp").val(msg['nombreResponsable']);		$(".panDatTitu").val(msg['titulo']);
          if (msg['tipo'] == null) {
            msg['tipo'] = "0";
          }
          switch (msg['tipo']) {
