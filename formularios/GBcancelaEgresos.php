...
<html>
	<head>
		<title> Cancelaci&oacute;n de Egresos Gasto B&aacute;sico</title>
	...
	?>
		...
		<fieldset id="base">
			<fieldset id="formulario">
				<legend> Cancelaciones en Gasto B&aacute;sico </legend>
				<form method="post" action="GBcancelaEgresos.php" name="form1">
			...
			<fieldset id="formulario">
				<?php
					...
					else
					{
						...
						{
							echo 		'<tr class="even">
											<td><a href="GBcancelaEgresosSube.php?codigo='.$reg['noCheque'].'"'?>onClick="alert(' Seguro que deseas cancelar el Cheque? ')"<?php echo '> <img src="../Imagen/cancel.png" width="25" height="25"></img></a></td>
											<td>'.$reg['noCheque'].'</td>
