...
<html>
	<head>
		<title> Valida Ingresos de Gasto B&aacute;sico </title>
...
//inicia busqueda de proyectos
		...
		<fieldset id="base">
			<fieldset id="formulario">
				<legend>Validador de Ingresos</legend>
				<form method="post" action="GBvalidaIngresos.php" name="form1">
		...
		while($reg = mysqli_fetch_array ($ingreso))
		{
			echo '
							<tr>';
								if($reg['tipo'] == 'ingreso')
								{
									echo'<td><a href="GBvalidaIngresos2.php?codigo='.$reg['no'].'"> <img src="../Imagen/writeNegro.png" width="25" height="25"></img></a></td>';
								}
								else
								{
