...
<html>
	<head>
		<title> Cancelaci&oacute;n de Egresos N&oacute;mina</title>
	...
	?>
		...
		<fieldset id="base">
			<fieldset id="formulario">
				<legend> Cancelaciones en N&oacute;mina </legend>
				<form method="post" action="NMcancelaEgresos.php" name="form1">
						...
						<td>
							<select name="noCheque">
								<?php
									...
									$registros = mysqli_query($con, "SELECT noCheque FROM egresosnm ORDER BY noCheque")
			...
			<fieldset id="formulario">
				<?php
					...
					else
					{
						...
						$registro = mysqli_query($con,"SELECT * FROM egresosnm
						...
						{
							echo 		'<tr class="even">
											<td><a href="NMcancelaEgresosSube.php?codigo='.$reg['noCheque'].'"'?>onClick="alert(' Seguro que deseas cancelar el Cheque? ')"<?php echo '> <img src="../Imagen/cancel.png" width="25" height="25"></img></a></td>
											<td>'.$reg['noCheque'].'</td>
