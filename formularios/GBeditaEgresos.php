...
//inicia busqueda de proyectos
		...
		<fieldset id="base">
			<fieldset id="formulario">
				<legend>Busqueda de Egresos Gasto B&aacute;sico</legend>
				<form method="post" action="GBeditaEgresos.php" name="form1">
		...
		if(!isset($_POST['val1']))
		{
			$egresos = mysqli_query($con, "SELECT noCheque, fechaElaboracion, nombre,
											concepto, total, comprobado,	restaComprobar
											FROM egresosgb
											ORDER BY noCheque")
		...
		echo '<fieldset id="formulario">
						<legend>Lista de Egresos Gasto B&aacute;sico Desglosados</legend>';
			...
			{
				echo '<tr>
						<td><a href="GBeditaEgresos2.php?codigo='.$reg['noCheque'].'"><img src="../Imagen/writeNegro.png" width="25" height="25"></img></a></td>
						<td>'.$reg['noCheque'].'</td>
