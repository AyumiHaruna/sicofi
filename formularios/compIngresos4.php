<?php
    ...
    $ingresos = mysqli_query($con, "SELECT * FROM ingresos WHERE noSolFon = $_REQUEST[codigo]") or die(mysqli_error($con));
		while($reg = mysqli_fetch_array($ingresos))
		{
			$noSolFon = $reg['noSolFon'];
			$mes = $reg['mes'];
    ...
    $caratNumber = 0;
      ...
      //get the validated ammount
        ...
        if( str_replace('C - ', '', $reg['caratula']) > $caratNumber ){
          $caratNumber = str_replace('C - ', '', $reg['caratula']);
        }
			}
		}
 ...
 ?>
  ...
  <html lang="en" dir="ltr">
    ...
    <body>
      ...
      <div class="container-fluid">
        <form  method="post" action="compIngresosSube.php" name="form1" id="mainForm">
          <div class="row">
                ...
                <div class="col-sm-12 block_square collapse in" id="datos_generales">
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <input type="date" name="fecha2" class="form-control" value="<?php echo date('Y-m-d');?>" required>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-sm-4 fixedtotales">
              <div class="row">
                ...
                <div class="col-sm-10 col-sm-offset-1 block_square collapse in" id="block_totales">
                  <div class="row">
                    <div class="col-sm-12">
                      <label for="total">Carátula: </label>
                      <input type="text" name ="carat" id="carat" class="form-control" value="C - <?php echo $caratNumber+1 ?>" readonly>
                    </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <input type="text" name ="previo" class="form-control" value="<?php echo number_format($compT, 2,'.',',') ?>" readonly>
                    </div>
  ...
  <script type="text/javascript">
    $( document ).ready(function() {
      ...
      var totalPrevio = <?php echo $compT; ?>;
      var totalResta;
      var thisSend;
      pintaPartidas();
