...
<html>
	<head>
		<title> Registro de Reintegros </title>
...
<!-- IIIIIIIIIIIIIIIIIIIIIIIIIIII 	Aqui se inicia el formulario  IIIIIIIIIIIIIIIIIIIIIIIIIIII -->
	<fieldset id="base">
		<fieldset id="formulario">
			<h2> Captura  de Reintegros </h2>
			<fieldset id="datos">
				<legend> Datos Generales </legend>
				<form method="post" action="altaReintegrosSube.php" name="form1">
				<table class="tablaForm" border="0">
				   ...
				   <tr>
						...
						<td colspan="2">
							<input type="text" value="REINTEGRO" name="tipo" readonly>
						</td>
				   </tr>
				   <tr>
						<td colspan="2">Mes:</td>
						...
						<td colspan="1"><input type="date" name="fechaDep1"></td>
				   </tr>
				   <tr>
