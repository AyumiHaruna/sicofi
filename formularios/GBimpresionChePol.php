...
<html>
	<head>
		<title> Impresion de Cheques y Polizas Gasto B&aacute;sico </title>
...
//si esta logueado muestra el menu correspondiente al nivel
		...
		<form method="post" action="GBimpresionChePol.php" name="form1">
		...
		$valor2 = $_POST['valor2'];
			$egresos = mysqli_query($con, "SELECT noCheque, fechaElaboracion, nombre,
												concepto, observaciones, total, comprobado,
												restaComprobar
												FROM egresosgb
				...
				echo '<fieldset id="formulario">
							<legend>Lista de Egresos Gasto B&aacute;sico</legend>';
		...
		<fieldset id="formulario">
				...
				<form method="post" action="GBgeneraChePol.php" name="form2">
				<table class="tablaForm">
					<tr>
