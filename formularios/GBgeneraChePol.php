...
<html>
	<head>
		<title> Impresion de Cheques y P&oacute;lizas Gasto B&aacute;sico</title>
		...
		echo '<fieldset id="base">
			<fieldset id="formulario">
				...
				<table class="tablaForm">
					<tr>
						<td><a href="GBgeneraCheque.php?a='.$valor1.'
								&b='.$valor2.'"target=_blank"><input type="button" value="Cheques"></a></td>
						<td><a href="GBgeneraPoliza.php?a='.$valor1.'
								&b='.$valor2.'"target=_blank"><input type="button" value="P&oacute;lizas"></a></td>
						<td><a href="GBimpresionChePol.php"><input type="button" value="Regresar"></a></td>
					</tr>
